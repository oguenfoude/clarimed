...
public class DicomListenerService : BackgroundService
{
    ...
    protected override async Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        var configSection = _configuration.GetSection("ClariMed");
        var aeTitle = configSection.GetValue<string>("AETitle") ?? "CLARIMED";
        ...
        _logger.LogInformation("ClariMed DICOM Listener starting — AE Title: {AETitle}, Port: {Port}", aeTitle, port);
        ...
        _logger.LogInformation("ClariMed DICOM Listener stopped.");
    }
}
