            ...
            Document.Create(container =>
            {
                container.Page(page =>
                {
                    ...
                    page.Footer()
                        ...
                        .Row(row =>
                        {
                            row.RelativeItem().Text($"Généré par FocusMed — {DateTime.Now:dd/MM/yyyy HH:mm}")
