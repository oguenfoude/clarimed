...
namespace FocusMed.Printing.Templates;
...
public class DefaultPrintTemplate : IPrintTemplate
{
        ...
        string? imagePath)
    {
        ...
        // ── Header: Clinic Name ──
        var headerText = string.IsNullOrWhiteSpace(clinicName) ? "FocusMed" : clinicName;
        ...
        var footerText = $"Printed: {DateTime.Now:yyyy-MM-dd HH:mm}  |  FocusMed";
